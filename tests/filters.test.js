...
import { DEFAULTS, toMinutes, isActive, applyFilters, hiddenFor, parseBusy, formatBusy } from "../js/filters.js";
...
const setAside = () => [entry("CSE", "5911", "Capstone", [
  section(5006, { instructionMode: "Distance Learning", meetings: [onlineMeeting()] }),
])];
